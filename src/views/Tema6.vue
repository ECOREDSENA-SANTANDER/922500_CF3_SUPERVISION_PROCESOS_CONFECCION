...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
        ...
        .fondo211.p-3.mb-2
          .row.justify-content-center.align-items-center
            .col-3.col-sm-2.col-lg-2
              img.mx-4.img-a.img-t(src="@/assets/curso/tema6/alert.svg")
            .col
    ...
    separador
    #t_6_1.titulo-segundo(data-aos="zoom-in-right")
      ...
      .col-sm-12.col-lg-6
        ...
        .col-lg-12
          .fondo21.p-3.mb-2
            .row.justify-content-around.align-items-center
              .col-3.col-sm-2.col-lg-2
                img(src="@/assets/curso/tema6/vieo.svg")
              .col
                .row.justify-content-between.align-items-center
                  .col.mb-3.mb-sm-0          
    ...
    separador
    #t_6_2.titulo-segundo(data-aos="zoom-in-right")
      .h2 6.2 Patrones Básicos masculinos
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-4
        ...
        figure
          img.mb-5(src='@/assets/curso/tema6/imggg.svg' alt="Imagen decorativa")
          figcaption.text-black Fuente: SENA, 2021
      .col-lg-4
        img.my-5(src='@/assets/curso/tema6/immm.png' alt="Imagen decorativa")

        
    .mb-4.d-flex.mb-5
      .d-flex.flex-wrap.align-items-center.pe-4.bg-img-blue
        h3.col.px-4.mb-0.text-white.mx-4(data-aos="fade-right") La camisa y sus variaciones
    ...
    .row.align-items-center.mb-5
      ...
      .col-lg-4.mb-4.mb-md-0(data-aos="fade-left")
        .titulo-sexto.color-acento-contenido
          ...
          | Camisa clásica
        figure
          img(src='@/assets/curso/tema6/camil.svg' alt="Imagen decorativa")
          figcaption.text-black Fuente: SENA, 2021

    
    p.mb-4.text-center A continuación, se recomienda leer los pasos detallados para realizar patrón camisa clásica en:
    ...
    .row.justify-content-center.align-items-center.mb-5 
      .col-sm-12.col-lg-8
        .fondo21.p-3.mb-2
          .row.justify-content-around.align-items-center
            .col-sm-12.col-lg-2
              img.img-a.img-t(src="@/assets/curso/tema6/pfd.svg")
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0          
      ...
      .col-sm-12.col-lg-8
        .fondo21.p-3.mb-2
          .row.justify-content-around.align-items-center
            .col-sm-12.col-lg-2
              img.img-a.img-t(src="@/assets/curso/tema6/vieo.svg")
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0          
                  h4.mb-1 Paso a paso de la base superior masculina slim fit 
    ...
    .row.justify-content-center.mb-5
      .col-sm-12.col-lg-10
        .row 
          .col-lg-5 
            img.mx-4.img-a.img-t(src="@/assets/curso/tema6/1130.png")
          .col-lg-7     
            ul.lista-ul--color
              li.d-flex
                i.fas.fa-car-side 
      ...
      .col-sm-6.col-lg-4.mb-4.mb-lg-4
        ...
        .fondo21e.p-4
          .row.justify-content-center.mb-4
            .col-3.my-2
              figure
                img(src='@/assets/curso/tema6/vieo.svg', alt='Texto que describa la imagen')
    ...
    .row.justify-content-center.items-align-center.mb-5
      .col-sm-12.col-lg-4
        .titulo-sexto.color-acento-contenido
          ...
          | Camisa clásica
        figure
          img(src='@/assets/curso/tema6/fig20.svg' alt="Imagen decorativa")
          figcaption.text-black Fuente: SENA, 2021
    
    
    separador
    #t_6_3.titulo-segundo(data-aos="zoom-in-right")
      .h2 6.3 Pantalón base

    p.mb-4 Para iniciar el trazo de la base inferior de pantalón masculino, se debe tomar las siguientes medidas:

    .row.justify-content-center.mb-4
      .col-sm-12.col-lg-4
        img.img-a.img-t.mb-4(src='@/assets/curso/tema6/6.5.png', alt='Texto que describa la imagen')
    ...
    .row.align-items-center.mb-5
      .col-lg-6.mb-4.mb-md-0(data-aos="fade-right")
        ...
        ul.lista-ul--color
          ...
          li.d-flex.mb-5
            strong.ori Esto se debe a que varias de las medidas curvas y demás son tomadas de la referencia del trazo del delantero.
          li.d-flex.mb-5
            i.fas.fa-car-side 
      ...
      .col-lg-6.mb-4.mb-md-0(data-aos="fade-left")
        .titulo-sexto.color-acento-contenido
          ...
          | Pantalón base
        figure
          img.mb-0(src='@/assets/curso/tema6/imgh.svg' alt="Imagen decorativa")
          figcaption.text-black Fuente: SENA, 2021
          ...
          .col-lg-5.mb-4.mb-md-0
            .row.justify-content-center.mb-4
              .col-lg-9.mb-4.mb-lg-0
                ...
                figure
                  img(src='@/assets/curso/tema6/malej.svg' alt="Imagen decorativa")
                  figcaption.text-black Fuente: SENA, 2021
            ...
            .row.justify-content-center.mb-4
              .col-lg-9.mb-4.mb-lg-0
                .titulo-sexto.color-acento-contenido
                  ...
                  | Pantalón Clásico Masculino
                figure
                  img(src='@/assets/curso/tema6/maleja.svg' alt="Imagen decorativa")
                  figcaption.text-black Fuente: SENA, 2021
