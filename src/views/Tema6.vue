  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .mb-4.d-flex.mb-5
      .d-flex.flex-wrap.align-items-center.pe-4.bg-img-blue
        h5.col.px-4.mb-0.text-white.mx-5(data-aos="fade-right") La camisa y sus variaciones
    ...
    .row.lis.align-items-center.py-4.mb-5
      .col-lg-12.col-12.px-lg-5.px-4
            ...
            .row.justify-content-center
              ...
              .col-lg-7     
                ul.lista-ul--color
                  ...
                  li.d-flex
                    i.fas.fa-car-side
                    p.mb-2 Para el desarrollo de la portañuela, prenses, pliegues y demás complementos de la manga, se debe tener en cuenta siempre el diseño y la referencia de la prenda.
                  li.d-flex
                    i.fas.fa-car-side
    ...
    .row.justify-content-center.mb-5
      .col-md-10.col-lg-4.col-10
        img.img-a.img-t.mb-4.my-4(src='@/assets/curso/tema6/6.5.png', alt="tema 6")
      .col-lg-8.mb-4.mb-md-0(data-aos="zoom-in-up")
        .titulo-sexto.color-acento-contenido
          h5 Tabla 4.
          | Tipo de plano y medidas
    ...
    .row.align-items-center.mb-3
      .col-lg-6.mb-4.mb-md-0(data-aos="fade-right")
        ...
        ul.lista-ul--color
          li.d-flex.mb-4
            i.fas.fa-car-side 
            p.mb-4 La base de pantalón sale en plano montado trazando primero la parte delantera y sobre el delantero trazando el posterior.
          li.d-flex.mb-5
        ...
        .row.justify-content-center.align-items-center.mb-5 
          .col-sm-12.col-lg-8
            .fondo21.p-3.mb-2
              .row.justify-content-around.align-items-center
                .col-sm-12.col-lg-2
                  img.img-a.img-t.d-none.d-lg-block(src="@/assets/curso/tema6/pfd.svg")
                .col
                  .row.justify-content-between.align-items-center
                    .col.mb-3.mb-sm-0          
